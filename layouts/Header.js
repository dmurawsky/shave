      ...
      <div>
        ...
        <nav
          ...
          <div id="search" className="field has-addons">
            <p
              ...
              <a id="searchSelectFacade" className="button is-static">
                {this.state.category}
              </a>
            </p>
            <p className="control">
        ...
        <nav
          ...
          <div className="navbar-menu">
            <div
              id="categoriesNav"
              className="sub-nav-dropdown navbar-item has-dropdown is-hoverable">
